...
def main(count):
    ...
    import openpyxl
    wb = openpyxl.load_workbook('clause_test.xlsx')
    wb2 = openpyxl.load_workbook('clause_test_output.xlsx')
    sheet = wb.active
    sheet2 = wb2.active
    global TotalCount
    output_line_count = 1
    ...
    while(TotalCount <= count):
        ...
        a_line = sheet["A"+str(TotalCount)].value
        ...
        try:
            ...
            num=0
            clauses += [""]
            sheet2["A"+str(output_line_count)] = ""
            output_line_count += 1
                    ...
                    if comma_found or verb_in_clause:
                        ...
                        if (comma_found and pos_tag(t[clause_starts:].split()[0].split())[0][1] == 'IN') or (comma_found and verb_in_clause):
                            #verb present or clause starts with preposition
                                ...
                                clauses += [clause]
                                sheet2["A"+str(output_line_count)] = clause
                                output_line_count += 1
...
# print("Total Count : ",TotalCount)
    wb2.save('clause_test_output.xlsx')
    return clauses
