...
def content(theurl):
    ...
    target = open("MatchLinks.txt", 'a')
    try:
        # line1 = soup.find_all('div', {"class": "teams"}).find('a')
        div = soup.find_all('div', "large-15 medium-15 small-20 columns content_data")
...
def main():
    theurl = "http://www.espncricinfo.com/icc-world-twenty20-2016/engine/series/901359.html"
    content(theurl)
    # line_number = 1
